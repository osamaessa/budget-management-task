...
class AddTransactionUseCase @Inject constructor(private val repository: TransactionsRepository) {

    operator fun invoke(transaction: Transaction) = repository.insert(transaction)
}